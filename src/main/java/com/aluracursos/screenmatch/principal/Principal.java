...
public class Principal {
    ...
    public void muestraElMenu() {
        ...
        while (opcion != 0) {
            var menu = """
                    ...
                    7 - Filtar series por temporadas y evaluación
    ...
    private void buscarEpisodioPorSerie() {
        mostrarSeriesBuscadas();
        System.out.println("Digita el nombre de la serie de la cual quieres ver los episodios");
        var nombreSerie = teclado.nextLine();
    ...
    private void buscarSerieWeb() {
        ...
        try {
            ...
            System.out.println("Serie guardada exitosamente: " + datos);
        } catch (DataIntegrityViolationException e) {
            System.out.println("!!Advertencia!!: El título de la serie ya existe en la base de datos.");
        }
    }
    ...
    private void buscarSeriesPorCategoria(){
        System.out.println("Escriba el genero/categoría de la serie que deseas buscar");
    ...
    private void buscarEpisodiosPorTitulo(){
        ...
        var nombreEpisodio = teclado.next();
        teclado.nextLine();
